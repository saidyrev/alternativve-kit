  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h1 class="mb-2 mx-2" style="line-height: 6rem; font-size: 6rem">Terlalu Lama Offline</h1>
        <h4 class="mb-2 mx-2">Anda Terlalu Lama Offline ⚠️</h4>
        <p class="mb-6 mx-2">Silahkan Login Kembali</p>
